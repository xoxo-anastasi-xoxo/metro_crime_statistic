const metro = [
  {
    ...
    name: "Сокольническая",
    ways: [
      {id: "w100", is_active: false, class: "st4", x: 1007.6, y: 199.8, width: 4.4, height: 7.6},
      ...
      {id: "w101", is_active: false, class: "st4", x: 995.6, y: 209.9, width: 17.6, height: 4.4,
        transform: "matrix(0.7054 -0.7088 0.7088 0.7054 145.5673 774.382)"},
      {id: "w10", is_active: false, class: "st4", x: 1007.6, y: 199.8, width: 4.4, height: 7.6},
      {id: "w10", is_active: false, class: "st4", x: 1007.6, y: 199.8, width: 4.4, height: 7.6},
      {id: "w10", is_active: false, class: "st4", x: 1007.6, y: 199.8, width: 4.4, height: 7.6},
      {id: "w10", is_active: false, class: "st4", x: 1007.6, y: 199.8, width: 4.4, height: 7.6},
      {id: "w10", is_active: false, class: "st4", x: 1007.6, y: 199.8, width: 4.4, height: 7.6},
...
{/*<rect x="960.4" y="243.5" transform="matrix(0.7054 -0.7088 0.7088 0.7054 111.8526 760.5135)" class="st4" width="20.9" height="4.4"/>*/}

  {/*<rect x="943.6" y="259.2" transform="matrix(0.7054 -0.7088 0.7088 0.7054 96.1659 754.1168)" class="st4" width="23.4" height="4.4"/>*/}

export default function login(state = metro, action) {
